...
op_v_moneda = op_inv_moneda = ac_monto_op_val = op_inv_id = op_v_id = suma_monts_nom = 0
...
# Ciclo principal arranca acà: Lectura del archivo, estructura basado en Ficha 11, pág. 227 (2025). Texto de prueba es ordenes_test1.txt tambien en el repositorio
...
print("suma total:", suma_monts_nom)
